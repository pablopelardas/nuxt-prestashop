...
<template>
  <div class="w-full h-full">
    <header class="relative border-0 bg-primary-700 border-neutral-200">
      <div
          class="flex mx-auto justify-between items-center flex-wrap md:flex-nowrap px-4 md:px-10 py-2 md:py-5 w-full h-full md:h-20 md:z-10 max-w-[1536px] mx-auto"
      >
        ...
        <nav class="md:flex flex-nowrap justify-end items-center md:ml-10 gap-x-1">
          <SfButton
      ...
      <div class="bg-white border-b border-b-neutral-200 border-b-solid">
        <div ref="referenceRef" class="max-w-[1536px] mx-auto">
          <nav ref="floatingRef">
            <ul
            ...
            >
              <li v-for="(menuNode, index) in content.children" :key="menuNode.key">
                ...
                <div
                    ...
                    ref="megaMenuRef"
                    :style="style"
                    class="hidden md:grid gap-x-6 grid-cols-4 bg-white shadow-lg p-6 left-0 right-0 outline-none max-w-[1536px]"
                    tabindex="0"
                    @mouseleave="close()"
